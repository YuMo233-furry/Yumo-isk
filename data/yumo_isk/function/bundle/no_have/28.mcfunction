execute if data entity @s Inventory[{Slot:28b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/29
execute if data entity @s Inventory[{Slot:28b}].components.minecraft:custom_data.YuMoIsk run return 0
