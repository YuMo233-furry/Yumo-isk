execute if data entity @s Inventory[{Slot:34b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/35
execute if data entity @s Inventory[{Slot:34b}].components.minecraft:custom_data.YuMoIsk run return 0
