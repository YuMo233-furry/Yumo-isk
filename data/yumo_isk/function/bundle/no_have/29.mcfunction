execute if data entity @s Inventory[{Slot:29b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/30
execute if data entity @s Inventory[{Slot:29b}].components.minecraft:custom_data.YuMoIsk run return 0
