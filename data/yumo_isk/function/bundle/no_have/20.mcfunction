execute if data entity @s Inventory[{Slot:20b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/21
execute if data entity @s Inventory[{Slot:20b}].components.minecraft:custom_data.YuMoIsk run return 0
