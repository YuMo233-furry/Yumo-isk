execute if data entity @s Inventory[{Slot:15b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/16
execute if data entity @s Inventory[{Slot:15b}].components.minecraft:custom_data.YuMoIsk run return 0
