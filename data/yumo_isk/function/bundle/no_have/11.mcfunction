execute if data entity @s Inventory[{Slot:11b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/12
execute if data entity @s Inventory[{Slot:11b}].components.minecraft:custom_data.YuMoIsk run return 0
