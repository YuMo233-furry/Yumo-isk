execute if data entity @s Inventory[{Slot:31b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/32
execute if data entity @s Inventory[{Slot:31b}].components.minecraft:custom_data.YuMoIsk run return 0
