execute if data entity @s Inventory[{Slot:14b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/15
execute if data entity @s Inventory[{Slot:14b}].components.minecraft:custom_data.YuMoIsk run return 0
