execute if data entity @s Inventory[{Slot:35b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/no_have/36
execute if data entity @s Inventory[{Slot:35b}].components.minecraft:custom_data.YuMoIsk run return 0
