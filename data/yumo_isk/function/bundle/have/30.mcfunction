execute unless data entity @s Inventory[{Slot:30b}].components.minecraft:custom_data.YuMoIsk run function yumo_isk:bundle/have/31
execute unless data entity @s Inventory[{Slot:30b}].components.minecraft:custom_data.YuMoIsk run return 0
execute if score execute yumo.isk.bundle_stack matches 1 run return 0
execute store result score Inventory yumo.isk.bundle_stack run data get entity @s Inventory[{Slot:30b}].components.minecraft:custom_data.YuMoIsk
execute if score Inventory yumo.isk.bundle_stack matches 64.. run function yumo_isk:bundle/have/31
...
execute unless entity @e[tag=yumo_item_bundle_tag] run function yumo_isk:bundle/have/31
execute unless entity @e[tag=yumo_item_bundle_tag] run return 0
execute if score execute yumo.isk.bundle_stack matches 1 run return 0
function yumo_isk:bundle/stack/clear
execute in yumo_cmp:yumo_cmp_load run data modify block 1 10 0 Items[{Slot:0b}].components set from entity @s Inventory[{Slot:30b}].components
...
execute in yumo_cmp:yumo_cmp_load run item replace entity @s container.30 from block 1 10 0 container.0
