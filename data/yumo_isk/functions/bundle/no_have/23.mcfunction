execute if data entity @s Inventory[{Slot:23b}].tag.YuMoIsk run function yumo_isk:bundle/no_have/24
execute if data entity @s Inventory[{Slot:23b}].tag.YuMoIsk run return 0
