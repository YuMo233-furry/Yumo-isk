#检测是不是收纳袋
execute if data entity @s Inventory[{Slot:9b}].tag.YuMoIsk run function yumo_isk:bundle/no_have/10
execute if data entity @s Inventory[{Slot:9b}].tag.YuMoIsk run return 0
