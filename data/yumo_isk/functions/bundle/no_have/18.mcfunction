execute if data entity @s Inventory[{Slot:18b}].tag.YuMoIsk run function yumo_isk:bundle/no_have/19
execute if data entity @s Inventory[{Slot:18b}].tag.YuMoIsk run return 0
execute if score execute yumo.isk.bundle_stack matches 1 run return 0
data modify storage yumo_isk Item set from entity @s Inventory[{Slot:18b}]
...
execute unless score yes yumo.isk.bundle_stack matches 1 run function yumo_isk:bundle/no_have/19
