...
execute in yumo_cmp:yumo_cmp_load run data modify block 0 10 1 Items set value [{Count:63b,Slot:0b,id:"minecraft:stone"},{Count:15b,Slot:1b,id:"minecraft:stone"}]
...
#生成实体_tag_2
execute in yumo_cmp:yumo_cmp_load positioned 0 10.5 1 run summon minecraft:item ~ ~ ~ {Item:{Count:1d,id:"minecraft:stone"},Tags:[yumo_item_ceiling_tag_2]}
