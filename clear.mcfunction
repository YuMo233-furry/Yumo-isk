...
execute as @a at @s if data entity @s SelectedItem.components.minecraft:custom_data.YuMoIsk unless data entity @s SelectedItem.components.minecraft:bundle_contents run particle minecraft:dust_plume ~ ~ ~ 0.2 0 0.2 0 25
